...
function SignUp() {
  ...
  return (
    <div className='min-h-screen grid lg:grid-cols-2 mt-10'>
      {/* leftside */}
      <div className="flex flex-col justify-center items-center h-auto p-6 sm:p-12">
      ...
      {/* rightside */}
        <AuthImagePattern
          title="Be vibrant, with a hint of sparkle."
          subtitle = "Connect with anyone! Chat Your Way, Every Day,Let the Words Flow!"
        />
